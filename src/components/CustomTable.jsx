...
const CustomTable = (props) => {
    ...
    useEffect(() => {
           dispatch(setOperationalCost({...currentOperationalCost,CostItemFixed:currentOperationalCost.CostItemVariable*100})); 
    }, [currentOperationalCost.CostItemVariable]);

    useEffect(() => {
           dispatch(setCapitalInvestment({...currentCapitalInvestment,total:currentCapitalInvestment.capex1 + currentCapitalInvestment.capex2})); 
    }, [currentCapitalInvestment.capex1,currentCapitalInvestment.capex2]);
